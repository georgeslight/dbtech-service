...
import de.htwberlin.service.Tray;
import de.htwberlin.service.TrayFinder;
...
import de.htwberlin.service.CoolingServiceDao;
...
public class CoolingServiceJavaTest {
  ...
  private static ICoolingService cs = new CoolingServiceDao();
  private static TrayFinder tf = new TrayFinder();
  ...
  @org.junit.Test
  public void testGetCommonTrays() {
    Tray tray2 = new Tray();
    tray2.setTrayId(2);
    tray2.setDiameterInCm(2);
    tray2.setCapacity(1);
    tray2.setExpirationDate(null);

    Tray tray4 = new Tray();
    tray4.setTrayId(4);
    tray4.setDiameterInCm(3);
    tray4.setCapacity(1);
    tray4.setExpirationDate(null);


    List<Tray> traysByDiameter = List.of(tray2);
    List<Tray> traysByExpirationDate = List.of(tray2, tray4);

    List<Tray> common = tf.getCommonTrays(traysByDiameter, traysByExpirationDate);
    Tray result = common.get(0);

    org.junit.Assert.assertEquals(tray2, result);
  }
